...
static void consolehelp() {
  ...
  printf("  The console is not very robust yet. There are only a few "
         "commands:\n\n");
  printf(
      "    change fd0        Mount a new image file on first floppy drive.\n");
  printf("                      Entering a blank line just ejects any current "
         "image file.\n");
  printf(
  ...
  printf(
      "    quit              Immediately abort emulation and close Fake86.\n");
}


int ConsoleThread(void *dummy) {
